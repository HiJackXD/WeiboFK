...
@interface JKProfileTableViewController () <UIPopoverPresentationControllerDelegate, JKStatusCellDelegate>
...
@implementation JKProfileTableViewController
...
- (void)loadNewStatus
{
    ...
    [mgr GET:@"https://api.weibo.com/2/statuses/user_timeline.json" parameters:params progress:^(NSProgress * _Nonnull downloadProgress) {
